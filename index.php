            ...
            <div class="row justify-content-between">
                <div class="banner_post_1 banner_post_bg_1">
                    <div class="banner_post_iner text-center">
                        <a href="archive.php"><h5> Gallerie</h5></a> 
                        <a href="archive.php"><h2>Tout notre savoir faire 
                            en quelques photos </h2></a> 
                        <p>Bibiche Coiffure</p>
                    </div>
                </div><div class="banner_post_1 banner_post_bg_2">
                    <div class="banner_post_iner text-center">
                        <a href="shop.php"><h5> Notre Magasin</h5></a> 
                        <a href="shop.php"><h2>Visitez notre magasin
                            en ligne</h2></a> 
                        <p>Bibiche Coiffure</p>
                    </div>
                </div>
                <div class="banner_post_1 banner_post_bg_3">
                    <div class="banner_post_iner text-center">
                        <a href="contact.php"><h5> Nous contacter</h5></a> 
                        <a href="contact.php"><h2>Laissez nous votre
                            message</h2></a> 
                        <p>Bibiche Coiffure</p>
                    </div>
                </div>
